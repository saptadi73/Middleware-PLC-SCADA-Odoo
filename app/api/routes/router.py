...
from app.api.routes.equipment_failure import router as equipment_failure_router
...
router.include_router(logs_router, prefix="/api/logs", tags=["System Logs"])
router.include_router(equipment_failure_router)
