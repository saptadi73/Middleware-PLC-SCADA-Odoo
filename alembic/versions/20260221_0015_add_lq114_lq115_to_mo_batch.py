"""add lq114 and lq115 equipment support to mo_batch table

Revision ID: 20260221_0015
Revises: 20260217_0014
Create Date: 2026-02-21

This migration adds support for two liquid tanks (LQ114 and LQ115)
to the mo_batch table with scada_tag-based naming convention:
...
revision = "20260221_0015"
down_revision = "20260217_0014"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.drop_column("mo_batch", "actual_consumption_lq_fml")
    op.drop_column("mo_batch", "consumption_lq_fml")
    op.drop_column("mo_batch", "component_lq_fml_name")
    op.drop_column("mo_batch", "lq115")

    # Remove LQ114 equipment support
    op.drop_column("mo_batch", "actual_consumption_lq_tetes")
    op.drop_column("mo_batch", "consumption_lq_tetes")
    op.drop_column("mo_batch", "component_lq_tetes_name")
    op.drop_column("mo_batch", "lq114")
